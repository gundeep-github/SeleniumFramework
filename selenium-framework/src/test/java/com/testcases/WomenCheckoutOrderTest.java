...
{    
    ...
    public void beforeMethod(Method method, ITestContext context)
    {
        ...
        String absolutePathLP= getDataPath(loginPage.DATASEEDING_DATA_FILENAME,
            dataFolderDP);
        List<Map<String, Object>> loginPagerows = CSVReader.readPayloadTemplate(absolutePathLP); 
    ...
    {    
        ...
        if (count0 > 0)
        {
            List<Map<String, Object>> rows = CSVReader.readPayloadTemplate(absolutePathWSP);
